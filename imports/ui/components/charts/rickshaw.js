...
(function() {
    ...
    Template.chartsRickshaw.onRendered(LoadRickshaw); // when template is ready, load rickshaw

    function LoadRickshaw(){
        $.getScript('/rickshaw/rickshaw.js', RickshawCharts); // when rickshaw was loaded, start the plugin
    }
